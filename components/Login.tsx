                        ...
                        <div className="relative bg-[#0F111A] rounded-[1.9rem] p-8 lg:p-10 overflow-hidden h-full">
                            ...
                            <>
                                ...
                                <button
                                    type="button"
                                    onClick={() => {
                                        // FIX UX-503: Substituir alert() por toast elegante
                                        notify.info('Login com Google em breve! Por enquanto, use e-mail e senha.');
                                    }}
                                    className="w-full bg-[#13141C] border border-[#1e293b] hover:bg-[#1A1C26] text-white text-sm font-medium py-3 rounded-xl transition-all flex items-center justify-center gap-3 mb-8 opacity-60 cursor-not-allowed"
                                    title="Em breve"
                                >

    ...
    return (
        <div className="flex flex-col gap-6 animate-in slide-in-from-right-8 duration-150 relative">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    type="number"
                                    autoFocus
                                    className="w-full bg-[#0b1221] border border-[#1e293b] rounded-xl px-4 py-3 text-white focus:border-slate-600 focus:ring-1 focus:ring-slate-700/50 outline-none font-bold text-lg"
                                    placeholder="0"
                                    value={purchaseQty}
                            ...
                            <div>
                                ...
                                <input
                                    type="number"
                                    className="w-full bg-[#0b1221] border border-[#1e293b] rounded-xl px-4 py-3 text-emerald-400 focus:border-slate-600 focus:ring-1 focus:ring-slate-700/50 outline-none font-bold text-lg"
                                    placeholder="0.00"
                                    value={purchaseCost}
            ...
            <header className="flex justify-between items-end">
                ...
                {/* TABS */}
                <div className="bg-[#0b1221] p-1 rounded-xl flex border border-[#1e293b]">
                    <button
                        onClick={() => setActiveTab('stock')}
                        className={`px-4 py-2 rounded-lg text-xs font-black uppercase tracking-widest transition-all flex items-center gap-2 ${activeTab === 'stock' ? 'bg-[#8B5CF6] text-white shadow-lg' : 'text-slate-500 hover:text-slate-300'}`}
                    >
                        <Package className="w-4 h-4" /> Estoque
                    </button>
                    <button
                        onClick={() => setActiveTab('buying')}
                        className={`px-4 py-2 rounded-lg text-xs font-black uppercase tracking-widest transition-all flex items-center gap-2 ${activeTab === 'buying' ? 'bg-[#8B5CF6] text-white shadow-lg' : 'text-slate-500 hover:text-slate-300'}`}
                    >
                ...
                {activeTab === 'stock' && (
                    <button
                        ...
                        className="bg-[#8B5CF6] hover:bg-[#7C3AED] text-white px-6 py-4 rounded-2xl font-black uppercase text-xs tracking-widest shadow-xl shadow-white/5 transition-all flex items-center gap-2 group"
                    >
            ...
            {activeTab === 'stock' ? (
                ...
                <>
                    {isAdding && (
                        <div className="bg-[#0b1221] border border-[#1e293b] p-6 rounded-2xl animate-in slide-in-from-top-4 mb-4">
                            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <select
                                        className="w-full bg-[#0b1221] border border-[#1e293b] rounded-xl px-4 py-3 text-slate-300 focus:border-slate-600 focus:ring-1 focus:ring-slate-700/50 outline-none font-bold"
                            ...
                            <div className="flex justify-end gap-3 mt-4 pt-4 border-t border-[#1e293b]">
                                ...
                                <button onClick={handleAdd} disabled={isSaving} className="px-8 py-3 bg-[#8B5CF6] text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-lg hover:bg-white/90 disabled:opacity-50 flex items-center gap-2">
                    ...
                    <div className="bg-[#0b1221] border border-[#1e293b] rounded-2xl p-8 min-h-[500px]">
                        <div className="flex items-center gap-4 mb-6 bg-[#1C1C26]/50 p-2 rounded-2xl border border-[#1e293b] w-full md:w-96">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {filtered.map((item) => (
                                <div key={item.id} className="bg-[#0f172a] p-5 rounded-xl border border-[#1e293b] group hover:border-slate-600 transition-all relative overflow-hidden">
                                    ...
                                    <div className="flex justify-between items-start mb-4">
                                        <div>
                                            <span className="text-[10px] font-black text-white uppercase tracking-widest bg-white/10 px-2 py-1 rounded-lg border border-[#1e293b]">{item.category}</span>
                                    ...
                                    <div className="flex items-end justify-between bg-[#0f172a] p-4 rounded-2xl border border-[#1e293b]">
                                        <div>
                ...
                // PURCHASING VIEW
                <div className="bg-[#0b1221] border border-[#1e293b] rounded-2xl p-8 min-h-[500px] animate-in slide-in-from-right-4">
                    <div className="mb-8">
                    ...
                    {calculating ? (
                        ...
                        <div className="text-center py-20 border-2 border-dashed border-[#1e293b] rounded-3xl">
                        ...
                        <div className="overflow-hidden rounded-2xl border border-[#1e293b]">
                            <table className="w-full text-left">
                                <thead className="bg-[#1C1C26] text-slate-400 text-[10px] font-black uppercase tracking-widest">
                                    <tr>

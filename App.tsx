...
// import { ChatWidget } from './components/CRM/ChatWidget'; // OCULTO — Evolution CRM não em uso no momento
  ...
  return (
    <div className="flex min-h-screen bg-[#0b1221] text-slate-200 relative">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        {/* <ChatWidget /> */} {/* OCULTO — Evolution CRM não em uso no momento */}
        ...
        <div className="p-4 md:p-10 max-w-[1600px] mx-auto w-full">
          <ErrorBoundary>
            ...
            <Suspense fallback={<PageSkeleton />}>
              ...
              {/* Evolution CRM — OCULTO (não em uso no momento)
      ...
      <UpdateChangelogModal isOpen={isChangelogOpen} onClose={() => setIsChangelogOpen(false)} />
    </div>
  );
};

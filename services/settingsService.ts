...
export const settingsService = {
    getSettings: async (): Promise<CompanySettings> => {
        ...
        return {
            ...
            // Injeta as credenciais oficiais caso não estejam salvas
            evolution_api_url: data.evolution_api_url || 'http://localhost:8080',
            evolution_api_key: data.evolution_api_key || 'GOMESZ_API_KEY_SECURE_2026',
            evolution_instance_name: data.evolution_instance_name || 'GMZ PERFORMACE ATENDIMENTO',
